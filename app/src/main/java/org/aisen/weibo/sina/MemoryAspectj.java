...
public class MemoryAspectj {
    ...
    @Pointcut("execution(* org.aisen.weibo.sina.ui.activity.base.MainActivity.onCreate(..))")
    //APP启动时的内存使用
    public void Mem2(){}
    @Before("Mem2()")
    ...
    @Pointcut("execution(* org.aisen.weibo.sina.ui.activity.base.MainActivity.onDestroy(..))")
